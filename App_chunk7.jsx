  ...
  return (
      ...
      rightPanel={
        <div className="right-panel-wrap">
          ...
          {showPerformancePanel && (
            <div className="spx-perf-overlay">
              <div className="spx-perf-overlay-header">
                <span>PERFORMANCE</span>
                <button onClick={() => setShowPerformancePanel(false)} className="spx-overlay-close">✕</button>
              </div>
    ...
    {/* ── TabPanelManager — ALL 22 tab panels rendered as FloatPanels outside ProfessionalShell ── */}
    <TabPanelManager
