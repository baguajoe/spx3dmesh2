...
export default function FloatPanel({ title, onClose, children, defaultX = 210, defaultY = 80, width = 380 }) {
  ...
  return (
    <div style={{ position: "fixed", left: pos.x, top: pos.y, width, zIndex: 500, background: "#0d1117", border: "1px solid #21262d", borderRadius: 8, boxShadow: "0 8px 32px rgba(0,0,0,0.7)", maxHeight: "calc(100vh - 100px)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div onMouseDown={onMouseDown} style={{ padding: "8px 12px", background: "#161b22", borderBottom: "1px solid #21262d", display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "move", userSelect: "none", fontFamily: "monospace", fontSize: 10, fontWeight: 700, color: "#00ffc8", letterSpacing: "0.1em", borderRadius: "8px 8px 0 0", flexShrink: 0 }}>
        <span>{title}</span>
