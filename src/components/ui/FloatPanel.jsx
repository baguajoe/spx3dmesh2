...
export default function FloatPanel({ title, onClose, children, defaultX = 210, defaultY = 80, width = 480 }) {
  ...
  return (
    <div style={{ position: "fixed", left: pos.x, top: pos.y, width, zIndex: 1500, background: "#0d1117", border: "1px solid #21262d", borderRadius: 8, boxShadow: "0 8px 32px rgba(0,0,0,0.7)", maxHeight: "calc(100vh - 100px)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
