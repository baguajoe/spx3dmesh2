...
function LiveViewportMirror({ rendererRef, open, label, bright }) {
  ...
  return (
    <div style={{flex:'0 0 45%',minWidth:0,display:'flex',flexDirection:'column',borderRight:'1px solid #21262d',background: bright ? '#0d1117' : '#060a10'}}>
...
{showPerformancePanel && (
      ...
      {nodeEditorOpen && (
        <div className="spx-fullscreen-overlay">
          ...
          <div className="spx-overlay-body" style={{flexDirection:"row",padding:0,overflow:"hidden"}}>
...
<div className="spx-overlay-body" style={{flexDirection:"row",padding:0}}>
            <LiveViewportMirror rendererRef={rendererRef} open={uvPanelOpen} label="UV — 3D SCENE" />
            <div style={{flex:1,minWidth:0,overflow:"hidden"}}>./components/mesh/NodeCompositorPanel';
import CustomSkinBuilderPanel from './components/panels/CustomSkinBuilderPanel';
import SPX3DTo2DPanel from './components/pipeline/SPX3DTo2DPanel';
import { WORKSPACES, DEFAULT_WORKSPACE } from "./pro-ui/workspaceMap";
import CityGeneratorPanel from './components/panels/CityGeneratorPanel';
